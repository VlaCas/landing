	...
	'use strict';
     ...
     function init_de() {
		...
		jQuery("#selector .opt").on("click", function() {
            ...
            jQuery("#colors").attr("href", 'static/css/colors/'+color+'.css');
            jQuery(this).addClass("active");
         });
     ...
     // rtl begin //
      if (rtl_mode=="on") {
            ...
            jQuery("#bootstrap").attr("href", 'static/css/bootstrap.rtl.min.css');
            jQuery("#bootstrap-grid").attr("href", 'static/css/bootstrap-grid.rtl.min.css');
            jQuery("#bootstrap-reboot").attr("href", 'static/css/bootstrap-reboot.rtl.min.css');
            jQuery("#mdb").attr("href", 'static/css/mdb.rtl.min.css');
            ...
            var iteration = $(this).data('iteration') || 1;
             switch (iteration) {
                 ...
                 case 2:
                    ...
                    jQuery("#bootstrap").attr("href", 'static/css/bootstrap.min.css');
                    jQuery("#bootstrap-grid").attr("href", 'static/css/bootstrap-grid.min.css');
                    jQuery("#bootstrap-reboot").attr("href", 'static/css/bootstrap-reboot.min.css');
                    jQuery("#mdb").attr("href", 'static/css/mdb.min.css');
